    ...
    <div className="space-y-5">
      <Card className="rounded-2xl border-[var(--line-subtle)]">
        <CardHeader>
          ...
          <CardDescription>Import tasks and projects files, then review sync logs below.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="outline" className="rounded-xl" onClick={() => setLogs([])}>
              Clear Logs
            </Button>
          </div>
