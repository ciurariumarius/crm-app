...
const SIDE_PANEL_BASE =
    "w-screen max-w-none p-0 flex flex-col overflow-hidden border-none bg-[var(--bg-surface)] shadow-[var(--shadow-drawer)] focus-visible:outline-none"
...
const SIDE_PANEL_DIALOG_BASE =
    "overflow-hidden rounded-2xl border border-[var(--line-subtle)] bg-[var(--surface-lowest)] p-0 shadow-[0_40px_100px_-45px_rgba(15,23,42,0.7)]"
...
export const SIDE_PANEL_DIALOG_HEADER_CLASS = "border-b border-[var(--line-subtle)] px-8 py-5"
