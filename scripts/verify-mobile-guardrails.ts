...
function run() {
  ...
  assert.match(workLog, /md:grid-cols-2/)
  assert.match(workLog, /grid grid-cols-3 gap-2 sm:flex sm:flex-wrap/)
  assert.match(workLog, /h-12 w-full shrink-0 items-center/)
  assert.match(workLog, /h-12! w-full min-w-44/)
