            ...
            {mobile ? (
                <div className="grid grid-cols-3 gap-2.5 md:hidden">
                    <button
                        ...
                        className="inline-flex h-[42px] items-center justify-center gap-1.5 rounded-[16px] bg-primary px-3 text-xs font-bold text-primary-foreground shadow-sm transition-colors hover:brightness-95"
                    >
                    ...
                    <button
                        ...
                        className="inline-flex h-[42px] items-center justify-center gap-1.5 rounded-[16px] border border-[var(--line-subtle)] bg-[var(--surface-lowest)] px-3 text-xs font-bold text-[var(--primary)] shadow-sm transition-colors hover:bg-[color:color-mix(in_srgb,var(--surface-lowest)_90%,var(--surface-low)_10%)]"
                    >
