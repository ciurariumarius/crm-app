    ...
    return (
        <Card className="p-4 border border-border bg-card/50 backdrop-blur-sm shadow-sm flex flex-col gap-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-bold text-sm uppercase tracking-wider text-muted-foreground">Rapid Entry Tools</h3>
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">URL Sniffer</label>
                        <span className="text-[10px] text-indigo-500 font-medium">Auto-detect</span>
                    </div>
                ...
                <div className="space-y-1.5 pt-1">
                    <div className="flex items-center justify-between">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Quick Site Note</label>
