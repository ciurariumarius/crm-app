    ...
    return (
        <div className={cn("grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4", className)}>
            ...
            <Card className="p-6 border-none shadow-sm bg-[var(--surface-lowest)] dark:bg-zinc-900 group hover:shadow-md transition-all duration-300">
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-semibold tracking-[0.03em] text-muted-foreground/60">This month</span>
                    </div>
                    <div>
            ...
            <Card className="p-6 border-none shadow-sm bg-[var(--surface-lowest)] dark:bg-zinc-900 group hover:shadow-md transition-all duration-300 border-l-4 border-l-rose-500/20">
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-[var(--state-danger-surface)] flex items-center justify-center text-[var(--state-urgent)]">
                            <AlertCircle className="h-5 w-5" />
                        </div>
                        <span className="text-xs font-semibold tracking-[0.03em] text-muted-foreground/60">Total unpaid</span>
                    </div>
                    <div>
                        <div className="text-2xl font-black tracking-tight text-[var(--state-urgent)]">{formatCurrency(allTimeUnpaidRevenue)}</div>
            ...
            <Card className="p-6 border-none shadow-sm bg-[var(--surface-lowest)] dark:bg-zinc-900 group hover:shadow-md transition-all duration-300">
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-[var(--sidebar-accent)] flex items-center justify-center text-[var(--primary)]">
                            <LayoutGrid className="h-5 w-5" />
                        </div>
                        <span className="text-xs font-semibold tracking-[0.03em] text-muted-foreground/60">Project status</span>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium text-muted-foreground">{activeMonthlyProjectsCount} Monthly</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <span className="h-1.5 w-1.5 rounded-full bg-[var(--text-muted)]" />
                                <span className="text-xs font-medium text-muted-foreground">{activeOneTimeProjectsCount} One-time</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <Card className="p-6 border-none shadow-sm bg-[var(--surface-lowest)] dark:bg-zinc-900 group hover:shadow-md transition-all duration-300">
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-[var(--state-warning-surface)] flex items-center justify-center text-[var(--state-warning)]">
                            <Sparkles className="h-5 w-5" />
                        </div>
                        <span className="text-xs font-semibold tracking-[0.03em] text-muted-foreground/60">Queue status</span>
                    </div>
                    <div>
                        <div className="text-2xl font-black tracking-tight text-foreground">
                            {totalActiveTasks} <span className="text-sm font-medium text-muted-foreground tracking-normal">Active Tasks</span>
                        </div>
                        <div className="mt-1 text-xs font-semibold tracking-[0.03em] text-[var(--state-warning)]">Requires attention</div>
                    </div>
                </div>
            </Card>
        </div>
