...
function ColumnsToggle({
  ...
  return (
    <div className="inline-flex h-9 items-center rounded-xl border border-[var(--line-subtle)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.9))] p-1 shadow-[0_2px_8px_rgba(15,23,42,0.02)]">
      {[3, 4].map((col) => (
        <button
          key={col}
          type="button"
          ...
          className={cn(
            ...
            currentCols === col ? "bg-white text-[var(--text-primary)] shadow-sm" : "text-[var(--text-muted)] hover:text-[var(--text-secondary)]"
          )}
        >
          {col}
        </button>
