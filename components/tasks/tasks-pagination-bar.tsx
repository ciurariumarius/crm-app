            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                    {display.prevPage ? (
                        ...
                        <span
                            className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-[var(--line-subtle)] bg-[color:color-mix(in_srgb,var(--surface-low)_76%,transparent)] text-[var(--text-muted)]"
                            aria-hidden="true"
                        >
                            <ChevronLeft className="h-4 w-4" />
                        </span>
